$GlobomanticsAccountKey = (Get-AzureRmStorageAccountKey -ResourceGroupName rgroup
                                                        -Name <storage account>).Value[0]

$GlobomanticsContext = New-AzureStorageContext -StorageAccountName <storage account>
                                               -StorageAccountKey $GlobomanticsAccountKey
