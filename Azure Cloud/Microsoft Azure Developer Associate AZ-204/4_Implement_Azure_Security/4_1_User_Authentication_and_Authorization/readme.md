    ...
    1. Management Plane
      - RBAC
        - Role based access control
          - Roles
            1. Security Principal: Somebody/Something that we want to grant access to. 
               - types:
                 a. A User
                 b. group of users
                 c. A Service(called Service Principal)
                   - username/password
          ...
          - Role Assignment
            ...
            - Multiple role assignments are additive: e.g. Owner + contributor
