...
# This new tag tells docker when it needs to send the image during docker push
...
#using ACR tasks to read the Dockerfile in the current working directory and
